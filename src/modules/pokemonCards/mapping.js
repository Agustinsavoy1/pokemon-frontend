      ...
      {pokemons &&
        pokemons?.map((pokemon) => {
          ...
          if (pokemon.types) {
            typesTo = [
              `${pokemon.types[0]?.name}${
                pokemon.types[1]?.name ? ", " + pokemon.types[1].name : " "
              }`,
            ];
          ...
          return (
            <div key={pokemon.id}>
              <div
                className={showDetail ? "Card" : "Card CardHover"}
                onClick={(e) => submitInfo(e, pokemon.name)}
              >
                ...
                <div className="contTypId">
                  ...
                  <p className="attackData">
                    🥊{pokemon.attack} 💙{pokemon.hp}
                  </p>
                  <p className="cardTypes">
                    {setIcon(pokemon) + " " + typesTo}{" "}
                  </p>
                </div>
              </div>
            </div>
